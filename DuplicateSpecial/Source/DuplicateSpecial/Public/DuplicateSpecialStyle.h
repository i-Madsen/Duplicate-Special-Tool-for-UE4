...
public:
		...
		: FSlateStyleSet("DuplicateSpecialStyle")
	{
		...
		Set("DuplicateSpecialMode", new FSlateImageBrush(RootToContentDir(TEXT("DefaultIcon40.png")), Icon40x40));
		Set("DuplicateSpecialMode.Small", new FSlateImageBrush(RootToContentDir(TEXT("DefaultIcon40.png")), Icon20x20));
